# Credenciale para testear

| Rol                     | Usuario    | Contraseña  |
| ----------------------- | ---------- | ----------- |
| Administrador           | `admin`    | `admin`     |
| Supervisor              | `rmora`    | `Demo2026$` |
| Facturador              | `gsalazar` | `Demo2026$` |
| Auxiliar de Cobranza    | `lnaranjo` | `Demo2026$` |
| Analista de Facturación | `pjimenez` | `Demo2026$` |

## Permisos por rol (mínimo privilegio)

- **Supervisor** — Acceso completo a Facturación, Inventario y Clientes; consulta de Movimientos; administración de Usuarios, Roles y Permisos.
